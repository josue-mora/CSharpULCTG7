...
namespace LCSharpMBG7.Code.DB.Dummies
{
    public class VehicleDbDummies
    {
        public static List<VehicleModel> CreateVehicles()
        {
            ...
            vehicleModels.Add(new VehicleModel("Coupe", "CLA", 2025, 0, "NEW", "Auto blanco", "cla_amg.png", false));
            vehicleModels.Add(new VehicleModel("Coupe", "GLE Coupe", 2025, 0, "NEW", "Auto blanco", "gle_coupe_amg.png", false));
            vehicleModels.Add(new VehicleModel("Roadster", "Mercedes AMG SL", 2025, 0, "NEW", "Auto blanco", "roadster_amg_sl.png", false));
            vehicleModels.Add(new VehicleModel("Hatchback", "Clase A Hatchback", 2025, 0, "NEW", "Auto blanco", "clase_a_hatchback.png", false));
            vehicleModels.Add(new VehicleModel("Sedan", "EQS Sedan", 2025, 0, "NEW", "Auto blanco", "eqs_sedan.png", false));
            vehicleModels.Add(new VehicleModel("Sedan", "Mercedes AMG Clase A Sedan", 2025, 0, "NEW", "Auto blanco", "clase_a_sedan.png", false));
            vehicleModels.Add(new VehicleModel("Sedan", "Clase C Sedan", 2025, 0, "NEW", "Auto blanco", "clase_c_sedan.png", false));
            vehicleModels.Add(new VehicleModel("Sedan", "Clase E Sedan", 2025, 0, "NEW", "Auto blanco", "clase_e_sedan.png", false));
